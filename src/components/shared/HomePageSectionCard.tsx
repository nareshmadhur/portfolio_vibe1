  ...
  return (
    <Link href={linkUrl} className={cn(
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8 md:p-10">
        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-primary-foreground group-hover:text-primary-foreground/90 transition-colors">{title}</h3>
